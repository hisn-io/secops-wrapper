    ...
    def search_curated_detections(
        ...
        Args:
            rule_id: Required. Unique ID of the curated rule to search
                detections for (e.g., "ur_ttp_GCP_MassSecretDeletion")
            ...
            alert_state: Optional. Filter by alert state. Can be
                AlertState enum or string. Valid values:
                AlertState.UNSPECIFIED, AlertState.NOT_ALERTING,
                AlertState.ALERTING
            page_size: Optional. Maximum detections to return (max 1000)
            page_token: Optional. Token for pagination
            max_resp_size_bytes: Optional. Maximum response size in bytes
            include_nested_detections: Optional. Include nested detections
